...
public class ventanaConsultar extends javax.swing.JDialog {
    ...
    private void buscarSolicitudes() {
        ...
        String filtroEmail = jTextFieldEmail.getText().trim().toLowerCase();
        String filtroTel = jTextFieldTel.getText().trim().toLowerCase();
        String filtroEstado = "";
        ...
        for (Solicitud solicitud : gestor.getSolicitudes()) {
            ...
            if (!filtroEmail.isEmpty()) {
                if (cliente.getEmail() == null || !cliente.getEmail().toLowerCase().contains(filtroEmail)) {
                    cumpleFiltros = false;
                }
            }
            ...
            if (!filtroTel.isEmpty()) {
                if (cliente.getTelefono() == null || !cliente.getTelefono().toLowerCase().contains(filtroTel)) {
                    cumpleFiltros = false;
                }
            }
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(jButtonBuscar, javax.swing.GroupLayout.DEFAULT_SIZE, 100,
                                                Short.MAX_VALUE)
                                        .addComponent(jButtonLimpiar, javax.swing.GroupLayout.DEFAULT_SIZE,
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addComponent(jButtonSalir, javax.swing.GroupLayout.PREFERRED_SIZE, 100,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(30, 30, 30)));
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGap(54, 54, 54))
                                        .addGroup(layout.createSequentialGroup()
                                                .addComponent(jButtonBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaConsultar.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
